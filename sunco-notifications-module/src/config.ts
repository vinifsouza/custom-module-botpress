 ...
 * For example, `data/bots/MY_BOT/config/sunco-notifications-module.json` will be used by MY_BOT, while `data/global/config/sunco-notifications-module.json` will be used for all others
 */
